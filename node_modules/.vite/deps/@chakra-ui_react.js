...
var InFocusGuard = function InFocusGuard2(_ref2) {
  ...
  return import_react64.default.createElement(import_react64.Fragment, null, import_react64.default.createElement("div", {
    key: "guard-first",
    "data-focus-guard": true,
    "data-focus-auto-guard": true,
    style: hiddenGuard
  }), children, children && import_react64.default.createElement("div", {
    key: "guard-last",
    "data-focus-guard": true,
    "data-focus-auto-guard": true,
    style: hiddenGuard
...
var focusScope = (0, import_react67.createContext)(void 0);

// node_modules/react-focus-lock/dist/es2015/Lock.js
var emptyArray = [];
var FocusLock = (0, import_react68.forwardRef)(function FocusLockUI(props, parentRef) {
  var _extends2;
  var _useState = (0, import_react68.useState)(), realObserved = _useState[0], setObserved = _useState[1];
  var observed = (0, import_react68.useRef)();
  var isActive = (0, import_react68.useRef)(false);
  var originalFocusedElement = (0, import_react68.useRef)(null);
  var _useState2 = (0, import_react68.useState)({}), update = _useState2[1];
  ...
  var _useState3 = (0, import_react68.useState)({}), id = _useState3[0];
  var onActivation = (0, import_react68.useCallback)(function(_ref2) {
  ...
  var onDeactivation = (0, import_react68.useCallback)(function() {
  ...
  var returnFocus = (0, import_react68.useCallback)(function(allowDefer) {
  ...
  var onFocus3 = (0, import_react68.useCallback)(function(event) {
    if (isActive.current) {
      mediumFocus.useMedium(event);
    }
  }, []);
  var onBlur3 = mediumBlur.useMedium;
  var setObserveNode = (0, import_react68.useCallback)(function(newObserved) {
  ...
  var focusScopeValue = (0, import_react68.useMemo)(function() {
    return {
      observed,
      shards,
      enabled: !disabled,
  ...
  return import_react68.default.createElement(import_react68.Fragment, null, hasLeadingGuards && [
    ...
    hasPositiveIndices ? import_react68.default.createElement("div", {
      key: "guard-nearest",
      "data-focus-guard": true,
      tabIndex: disabled ? -1 : 1,
      style: hiddenGuard
    }) : null
  ], !disabled && import_react68.default.createElement(SideCar2, {
    id,
    ...
    focusOptions,
    noFocusGuards
  }), import_react68.default.createElement(Container3, _extends({
    ref: mergedRef
  }, lockProps, {
    className,
    onBlur: onBlur3,
    onFocus: onFocus3
  }), import_react68.default.createElement(focusScope.Provider, {
    value: focusScopeValue
  }, children)), hasTailingGuards && import_react68.default.createElement("div", {
    "data-focus-guard": true,
    tabIndex: disabled ? -1 : 0,
    style: hiddenGuard
  }));
...
// node_modules/react-focus-lock/dist/es2015/Combination.js
var FocusLockCombination = (0, import_react71.forwardRef)(function FocusLockUICombination(props, ref) {
  return import_react71.default.createElement(Lock_default, _extends({
...
var AutoFocusInside = function AutoFocusInside2(_ref2) {
  ...
  return import_react72.default.createElement("div", _extends({}, inlineProp(FOCUS_AUTO, !disabled), {
    className
  }), children);
};
...
function MoveFocusInside(_ref2) {
  ...
  return import_react73.default.createElement("div", _extends({}, inlineProp(FOCUS_AUTO, !isDisabled3), {
    ref,
    className
  }), children);
}
...
var FreeFocusInside = function FreeFocusInside2(_ref2) {
  ...
  return import_react74.default.createElement("div", _extends({}, inlineProp(FOCUS_ALLOW, true), {
    className
  }), children);
};
...
function useShortcut(props = {}) {
  ...
  const [keys2, setKeys] = (0, import_react79.useState)([]);
...
var useSafeLayoutEffect3 = isBrowser3 ? import_react80.useLayoutEffect : import_react80.useEffect;

// node_modules/@chakra-ui/hooks/dist/chunk-KA2477BY.mjs
var import_react81 = __toESM(require_react(), 1);
function useCallbackRef3(fn2, deps = []) {
  const ref = (0, import_react81.useRef)(fn2);
...
function useWhyDidYouUpdate(name, props) {
  const previousProps = (0, import_react83.useRef)();
...
function useMouseDownRef(shouldListen = true) {
  const mouseDownRef = (0, import_react88.useRef)();
...
function usePanGesture(ref, props) {
  ...
  const panSession = (0, import_react91.useRef)(null);
  const handlers2 = {
...
function useOptionalPart(partId) {
  const [id, setId] = (0, import_react92.useState)(null);
  const ref = (0, import_react92.useCallback)(
    (node3) => {
...
function useControllableState2(props) {
  ...
  const [valueState, setValue] = (0, import_react93.useState)(defaultValue);
  const isControlled = valueProp !== void 0;
  const value = isControlled ? valueProp : valueState;
  const updateValue = (0, import_react93.useCallback)(
    (next2) => {
...
function useEventListenerMap() {
  const listeners = (0, import_react95.useRef)(/* @__PURE__ */ new Map());
  const currentListeners = listeners.current;
  const add3 = (0, import_react95.useCallback)((el, type, listener, options) => {
  ...
  const remove = (0, import_react95.useCallback)(
...
var useUpdateEffect2 = (effect5, deps) => {
  const renderCycleRef = (0, import_react96.useRef)(false);
  const effectCycleRef = (0, import_react96.useRef)(false);
...
function useFocusOnShow(target, options = defaultOptions2) {
  ...
  const autoFocusRef = (0, import_react97.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react97.useRef)(visible);
  useSafeLayoutEffect3(() => {
...
function useForceUpdate() {
  const unloadingRef = (0, import_react98.useRef)(false);
  const [count, setCount] = (0, import_react98.useState)(0);
  useUnmountEffect(() => {
    unloadingRef.current = true;
  });
  return (0, import_react98.useCallback)(() => {
...
function useAnimationState(props) {
  ...
  const [mounted, setMounted] = (0, import_react99.useState)(isOpen);
  const [once2, setOnce] = (0, import_react99.useState)(false);
...
function useBoolean(initialState2 = false) {
  const [value, setValue] = (0, import_react100.useState)(initialState2);
  const callbacks = (0, import_react100.useMemo)(
    () => ({
      on: () => setValue(true),
      off: () => setValue(false),
...
function useClipboard(value, optionsOrTimeout = {}) {
  const [hasCopied, setHasCopied] = (0, import_react101.useState)(false);
  const [valueState, setValueState] = (0, import_react101.useState)(value);
  (0, import_react101.useEffect)(() => setValueState(value), [value]);
  const { timeout = 1500, ...copyOptions } = typeof optionsOrTimeout === "number" ? { timeout: optionsOrTimeout } : optionsOrTimeout;
  const onCopy = (0, import_react101.useCallback)(() => {
...
function useDimensions(ref, observe) {
  const [dimensions, setDimensions] = (0, import_react103.useState)(null);
  const rafId = (0, import_react103.useRef)();
  useSafeLayoutEffect3(() => {
    function measure() {
      const node3 = ref.current;
      if (!node3)
...
var Wrap = forwardRef3(function Wrap2(props, ref) {
  ...
  const _children = (0, import_react105.useMemo)(
    () => shouldWrapChildren ? import_react105.Children.map(children, (child, index) => (0, import_jsx_runtime76.jsx)(WrapItem, { children: child }, index)) : children,
...
var Stack = forwardRef3((props, ref) => {
  ...
  const dividerStyle = (0, import_react106.useMemo)(
  ...
  const clones = (0, import_react106.useMemo)(() => {
    ...
    return shouldUseChildren ? validChildren : validChildren.map((child, index) => {
      ...
      if (!hasDivider)
        return _child;
      const clonedDivider = (0, import_react106.cloneElement)(
        divider,
        {
          __css: dividerStyle
        }
      ...
      return (0, import_jsx_runtime79.jsxs)(import_react106.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime85.jsx)(import_jsx_runtime85.Fragment, { children: chunks.map((chunk2, index) => {
    return chunk2.match ? (0, import_jsx_runtime85.jsx)(Mark, { sx: styles2, children: chunk2.text }, index) : (0, import_jsx_runtime85.jsx)(import_react107.Fragment, { children: chunk2.text }, index);
  }) });
}
...
var Indicator = forwardRef3(function Indicator2(props, ref) {
  ...
  const styles2 = (0, import_react108.useMemo)(
    () => ({
      display: "inline-flex",
      justifyContent: "center",
      alignItems: "center",
...
var AspectRatio = forwardRef3(function(props, ref) {
  ...
  const child = import_react109.Children.only(children);
...
function useMediaQuery(query, options = {}) {
  ...
  const [value, setValue] = (0, import_react110.useState)(() => {
...
function useShortcut2(props = {}) {
  const { timeout = 300, preventDefault = () => true } = props;
  const [keys2, setKeys] = (0, import_react111.useState)([]);
  const timeoutRef = (0, import_react111.useRef)();
  const flush = () => {
    if (timeoutRef.current) {
      clearTimeout(timeoutRef.current);
      timeoutRef.current = null;
  ...
  (0, import_react111.useEffect)(() => flush, []);
  function onKeyDown(fn2) {
    return (event) => {
      if (event.key === "Backspace") {
        const keysCopy = [...keys2];
...
function useEventListeners() {
  ...
  const currentListeners = listeners.current;
  const add3 = (0, import_react112.useCallback)((el, type, listener, options) => {
...
function useClickable(props = {}) {
  ...
  const trulyDisabled = isDisabled3 && !isFocusable3;
  const handleClick = (0, import_react113.useCallback)(
    (event) => {
      if (isDisabled3) {
        event.stopPropagation();
        event.preventDefault();
  ...
  const onDocumentKeyUp = (0, import_react113.useCallback)(
    (e) => {
  ...
  const handleKeyUp = (0, import_react113.useCallback)(
    (event) => {
  ...
  const onDocumentMouseUp = (0, import_react113.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      setIsPressed(false);
  ...
  const handleMouseDown = (0, import_react113.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (isDisabled3) {
  ...
  const handleMouseUp = (0, import_react113.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (!isButton) {
  ...
  const handleMouseOver = (0, import_react113.useCallback)(
    (event) => {
      if (isDisabled3) {
        event.preventDefault();
        return;
  ...
  const handleMouseLeave = (0, import_react113.useCallback)(
    (event) => {
      if (isPressed) {
        event.preventDefault();
        setIsPressed(false);
...
function usePopper(props = {}) {
  ...
  const reference2 = (0, import_react115.useRef)(null);
  const popper2 = (0, import_react115.useRef)(null);
  const instance = (0, import_react115.useRef)(null);
  const placement = getPopperPlacement(placementProp, direction2);
  const cleanup = (0, import_react115.useRef)(() => {
  });
  const setupPopper = (0, import_react115.useCallback)(() => {
    var _a8;
  ...
  const referenceRef = (0, import_react115.useCallback)(
    (node3) => {
  ...
  const getReferenceProps = (0, import_react115.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const popperRef = (0, import_react115.useCallback)(
    (node3) => {
  ...
  const getPopperProps = (0, import_react115.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const getArrowProps = (0, import_react115.useCallback)((props2 = {}, ref = null) => {
  ...
  const getArrowInnerProps = (0, import_react115.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-popper-arrow-inner": ""
...
function useDisclosure2(props = {}) {
  ...
  const uid = (0, import_react116.useId)();
...
function useAnimationState2(props) {
  ...
  const [once2, setOnce] = (0, import_react118.useState)(false);
...
function useMenu(props = {}) {
  ...
  const rafId = (0, import_react119.useRef)(null);
  return {
    openAndFocusMenu,
...
function useMenuItem(props = {}, externalRef = null) {
  ...
  const id = `${menuId}-menuitem-${(0, import_react119.useId)()}`;
  const { index, register } = useMenuDescendant({
    disabled: isDisabled3 && !isFocusable3
  });
  const onMouseEnter = (0, import_react119.useCallback)(
    (event) => {
  ...
  const onMouseMove = (0, import_react119.useCallback)(
    (event) => {
  ...
  const onMouseLeave = (0, import_react119.useCallback)(
    (event) => {
  ...
  const onClick = (0, import_react119.useCallback)(
    (event) => {
...
var Menu = (props) => {
  ...
  const context = (0, import_react120.useMemo)(() => ctx, [ctx]);
...
var StyledMenuItem = forwardRef3(
  (props, ref) => {
    ...
    const buttonStyles = (0, import_react121.useMemo)(
      () => ({
        textDecoration: "none",
        color: "inherit",
        userSelect: "none",
...
var MenuIcon = (props) => {
  ...
  const clone = (0, import_react122.isValidElement)(child) ? (0, import_react122.cloneElement)(child, {
    focusable: "false",
    "aria-hidden": true,
...
var ModalTransition = (0, import_react123.forwardRef)(
  (props, ref) => {
...
function useModalManager(ref, isOpen) {
  const [index, setIndex] = (0, import_react124.useState)(0);
...
function useModal(props) {
  ...
  const dialogRef = (0, import_react125.useRef)(null);
  const overlayRef = (0, import_react125.useRef)(null);
  ...
  const mouseDownTarget = (0, import_react125.useRef)(null);
  const onMouseDown = (0, import_react125.useCallback)((event) => {
  ...
  const [headerMounted, setHeaderMounted] = (0, import_react125.useState)(false);
  const [bodyMounted, setBodyMounted] = (0, import_react125.useState)(false);
  const getDialogProps = (0, import_react125.useCallback)(
    (props2 = {}, ref = null) => ({
      role: "dialog",
      ...props2,
  ...
  const onOverlayClick = (0, import_react125.useCallback)(
    (event) => {
      event.stopPropagation();
  ...
  const getDialogContainerProps = (0, import_react125.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
...
function useSpinner(increment, decrement) {
  const [isSpinning, setIsSpinning] = (0, import_react131.useState)(false);
  const [action, setAction] = (0, import_react131.useState)(null);
  const [runOnce, setRunOnce] = (0, import_react131.useState)(true);
  const timeoutRef = (0, import_react131.useRef)(null);
  ...
  const up = (0, import_react131.useCallback)(() => {
    if (runOnce) {
      increment();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const down = (0, import_react131.useCallback)(() => {
    if (runOnce) {
      decrement();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const stop = (0, import_react131.useCallback)(() => {
    setRunOnce(true);
    setIsSpinning(false);
    removeTimeout();
  }, []);
...
function useNumberInput(props = {}) {
  ...
  const inputSelectionRef = (0, import_react132.useRef)(null);
  const incrementButtonRef = (0, import_react132.useRef)(null);
  const decrementButtonRef = (0, import_react132.useRef)(null);
  const sanitize = (0, import_react132.useCallback)(
    (value) => value.split("").filter(isValidCharacter).join(""),
    [isValidCharacter]
  );
  const parse6 = (0, import_react132.useCallback)(
    (value) => {
      var _a8;
  ...
  const format = (0, import_react132.useCallback)(
    (value) => {
      var _a8;
  ...
  const increment = (0, import_react132.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        incrementFn(step);
      }
  ...
  const decrement = (0, import_react132.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        decrementFn(step);
      }
  ...
  const _onFocus = (0, import_react132.useCallback)(
    (event) => {
      var _a8, _b5, _c3;
  ...
  const ariaValueText = (0, import_react132.useMemo)(() => {
  ...
  const validateAndClamp = (0, import_react132.useCallback)(() => {
  ...
  const onInputBlur = (0, import_react132.useCallback)(() => {
    setFocused(false);
    if (clampValueOnBlur) {
      validateAndClamp();
    }
  ...
  const spinUp = (0, import_react132.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.up();
      focusInput();
  ...
  const spinDown = (0, import_react132.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.down();
      focusInput();
  ...
  const getIncrementButtonProps = (0, import_react132.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getDecrementButtonProps = (0, import_react132.useCallback)(
    (props2 = {}, ref = null) => {
...
function usePinInput(props = {}) {
  ...
  const [moveFocus2, setMoveFocus] = (0, import_react134.useState)(true);
  ...
  const focusNext = (0, import_react134.useCallback)(
    (index) => {
  ...
  const setValue = (0, import_react134.useCallback)(
  ...
  const clear = (0, import_react134.useCallback)(() => {
    var _a8;
  ...
  const getNextValue = (0, import_react134.useCallback)((value2, eventValue) => {
...
function PinInput(props) {
  ...
  const clones = getValidChildren2(children).map(
    (child) => (0, import_react135.cloneElement)(child, { __css: styles2 })
  );
...
function PopoverTrigger(props) {
  const child = import_react136.Children.only(props.children);
  const { getTriggerProps } = usePopoverContext();
  return (0, import_react136.cloneElement)(child, getTriggerProps(child.props, child.ref));
}
...
function PopoverAnchor(props) {
  ...
  return (0, import_react138.cloneElement)(child, getAnchorProps(child.props, child.ref));
}
...
function useRadioGroup(props = {}) {
  ...
  const [valueState, setValue] = (0, import_react139.useState)(defaultValue || "");
  const isControlled = typeof valueProp !== "undefined";
  const value = isControlled ? valueProp : valueState;
  const ref = (0, import_react139.useRef)(null);
  const focus2 = (0, import_react139.useCallback)(() => {
  ...
  const getRadioProps = (0, import_react139.useCallback)(
    (props2 = {}, ref2 = null) => {
      const checkedKey = isNative ? "checked" : "isChecked";
      return {
        ...props2,
...
var RadioGroup = forwardRef3((props, ref) => {
  ...
  const group = (0, import_react140.useMemo)(
    () => ({
      name,
      size: size2,
      onChange,
...
function useRadio(props = {}) {
  ...
  const uuid = `radio-${(0, import_react141.useId)()}`;
  ...
  const [isFocusVisible2, setIsFocusVisible] = (0, import_react141.useState)(false);
  const [isFocused, setFocused] = (0, import_react141.useState)(false);
  const [isHovered, setHovering] = (0, import_react141.useState)(false);
  const [isActive, setActive] = (0, import_react141.useState)(false);
  const [isCheckedState, setChecked] = (0, import_react141.useState)(Boolean(defaultChecked));
  const isControlled = typeof isCheckedProp !== "undefined";
  const isChecked = isControlled ? isCheckedProp : isCheckedState;
  (0, import_react141.useEffect)(() => {
    return trackFocusVisible(setIsFocusVisible);
  }, []);
  const handleChange = (0, import_react141.useCallback)(
    (event) => {
      if (isReadOnly || isDisabled3) {
        event.preventDefault();
        return;
  ...
  const onKeyUp = (0, import_react141.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
...
var SelectIcon = (props) => {
  ...
  const clone = (0, import_react142.cloneElement)(children, {
    role: "presentation",
  ...
  return (0, import_jsx_runtime140.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react142.isValidElement)(children) ? clone : null });
};
...
function useIsFirstRender() {
  const isFirstRender = (0, import_react143.useRef)(true);
...
function usePrevious2(value) {
  const ref = (0, import_react144.useRef)();
...
function usePanEvent(ref, options) {
  ...
  const panSession = (0, import_react146.useRef)(null);
...
var useSafeLayoutEffect4 = Boolean(globalThis == null ? void 0 : globalThis.document) ? import_react147.useLayoutEffect : import_react147.useEffect;
...
function useSizes({
  ...
  const [sizes24, setSizes] = (0, import_react147.useState)([]);
  const [count, setCount] = (0, import_react147.useState)(0);
...
function useRangeSlider(props) {
  ...
  const [activeIndex, setActiveIndex] = (0, import_react148.useState)(-1);
  const isInteractive = !(isDisabled3 || isReadOnly);
  const initialValue = (0, import_react148.useRef)(valueState);
  ...
  const stateRef = (0, import_react148.useRef)({
    eventSource: null,
    value: [],
    valueBounds: []
  });
  ...
  const getValueFromPointer = (0, import_react148.useCallback)(
    (event) => {
      var _a8, _b5;
      if (!trackRef.current)
        return;
  ...
  const getTrackProps = (0, import_react148.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
  ...
  const getInnerTrackProps = (0, import_react148.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getThumbProps = (0, import_react148.useCallback)(
    (props2, ref = null) => {
      var _a8;
      const { index, ...rest } = props2;
  ...
  const getOutputProps = (0, import_react148.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getMarkerProps = (0, import_react148.useCallback)(
    (props2, ref = null) => {
...
var RangeSlider = forwardRef3(
  function RangeSlider2(props, ref) {
    ...
    const ctx = (0, import_react149.useMemo)(
...
function useSlider(props) {
  ...
  const [isDragging, setDragging] = (0, import_react150.useState)(false);
  ...
  const trackRef = (0, import_react150.useRef)(null);
  const thumbRef = (0, import_react150.useRef)(null);
  const rootRef = (0, import_react150.useRef)(null);
  const reactId = (0, import_react150.useId)();
  const uuid = idProp != null ? idProp : reactId;
  const [thumbId, trackId] = [`slider-thumb-${uuid}`, `slider-track-${uuid}`];
  const getValueFromPointer = (0, import_react150.useCallback)(
    (event) => {
      var _a24, _b5;
      if (!trackRef.current)
        return;
  ...
  const constrain = (0, import_react150.useCallback)(
    (value2) => {
      const state22 = stateRef.current;
  ...
  const { getThumbStyle, rootStyle, trackStyle, innerTrackStyle } = (0, import_react150.useMemo)(() => {
    const state22 = stateRef.current;
  ...
  const focusThumb = (0, import_react150.useCallback)(() => {
    const state22 = stateRef.current;
  ...
  const getTrackProps = (0, import_react150.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref: mergeRefs2(ref, trackRef),
  ...
  const getInnerTrackProps = (0, import_react150.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getThumbProps = (0, import_react150.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
  ...
  const getMarkerProps = (0, import_react150.useCallback)(
    (props2, ref = null) => {
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react154.useState)(defaultIndex != null ? defaultIndex : 0);
...
function useTooltip(props = {}) {
  ...
  const enterTimeout = (0, import_react156.useRef)();
  const clearEnterTimeout = (0, import_react156.useCallback)(() => {
    if (enterTimeout.current) {
      clearTimeout(enterTimeout.current);
      enterTimeout.current = void 0;
    }
  }, []);
  const exitTimeout = (0, import_react156.useRef)();
  const clearExitTimeout = (0, import_react156.useCallback)(() => {
    if (exitTimeout.current) {
      clearTimeout(exitTimeout.current);
      exitTimeout.current = void 0;
    }
  }, []);
  const closeNow = (0, import_react156.useCallback)(() => {
    clearExitTimeout();
    onClose();
  }, [onClose, clearExitTimeout]);
  const dispatchCloseEvent = useCloseEvent(ref, closeNow);
  const openWithDelay = (0, import_react156.useCallback)(() => {
  ...
  const closeWithDelay = (0, import_react156.useCallback)(() => {
    clearEnterTimeout();
    const win = getWin(ref);
  ...
  const onPointerDown = (0, import_react156.useCallback)(() => {
  ...
  const getTooltipPositionerProps = (0, import_react156.useCallback)(
    (props2 = {}, forwardedRef = null) => getPopperProps(
      {
        ...props2,
        style: {
  ...
  const getTooltipProps = (0, import_react156.useCallback)(
    (props2 = {}, ref2 = null) => {
      const styles2 = {
        ...props2.style,
        position: "relative",
...
var Tooltip = forwardRef3((props, ref) => {
  ...
  if (shouldWrap) {
    ...
    trigger2 = (0, import_react157.cloneElement)(
      child,
